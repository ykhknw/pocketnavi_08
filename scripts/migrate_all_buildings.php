<?php
/**
 * 検索履歴filters移行（building全件）
 * 
 * 対象: global_search_historyテーブルのpageType="building"の全データ
...
class AllBuildingsMigrator {
    ...
    public function migrateAll() {
        echo "<h2>検索履歴filters移行（building全件）</h2>";
        echo "<hr>";
    ...
    public function showStatistics() {
        ...
        echo "<p><strong>building検索総数:</strong> {$total}件</p>";
...
<div class="warning">
    <strong>⚠️ 注意:</strong> このスクリプトは本番データベースのbuilding検索データを一括移行します。実行前に必ずバックアップを取得してください。
</div>

<?php
// 実行部分
try {
    $migrator = new AllBuildingsMigrator();
